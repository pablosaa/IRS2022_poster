\documentclass[portrate,a0paper,fontscale=0.4,margin=1cm]{baposter}
...
\begin{minipage}{0.9\textwidth}
	\setcaptiontype{figure}
	\centering
	\subfloat{\includegraphics[width=.7\linewidth]{drawing_lead_cloud.png}}
...
\begin{minipage}{0.9\textwidth}
	\setcaptiontype{figure}
	\centering
	\subfloat{\includegraphics[width=0.6\linewidth]{images/coupling_no_coupling_bigfont}}
	%\caption{\smaller Coupling / decoupling .}
	\label{fig:cop-dec}
\end{minipage}
...
{\Small
\begin{itemize}
		\item Ground-based radiation observations at the ARM site at the North Slope of Alaska (NSA) have been analyzed for the period of winters 2012 to 2020. The data has been classified into sea ice - cloud coupled/ decoupled cases.
		\item Results are consistent with previous findings regarding the effect of low sea ice concentration (e.g., due to the presence of leads or polynyas) on cloud micro- and macro-physical properties~[\ref{bib:garfias2021}].
...
{\tiny
	\begin{enumerate}
		...
		\item \label{bib:garfias2021}Saavedra~Garfias, P. et al. "Climatology of clouds containing supercooled liquid in the Western and Central Arctic". American Geophysical Union (2021), ESSOAR. DOI10.1002/essoar.10509918.1
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{Acknowledges}{name=acknown,column=0, span=2, below=methods}{
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	{\smaller This work is supported by the DFG funded Transregio-project TR-172 "Arctic Amplification $(AC)^3$". Authors thank to DOE ARM program for providing NSA data. SIC product is obtained from the University of Bremen under supported by Dr. Gunnar Spreen. Cloud classification performed with open-source \emph{Cloudnetpy} by ACTRIS and FMI.
	}{\large \textbf Gedruckt im Universitätsrechenzentrum Leipzig}
}
\headerbox{[*] Contact}{name=contact, column=2, above=bottom}{
{\Large Email:	pablo.saavedra@uni-leipzig.de}\\
