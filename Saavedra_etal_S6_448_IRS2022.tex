...
\begin{itemize}
		...
		\item Results are consistent with previous findings regarding the effect of low sea ice concentration (e.g., due to the presence of leads or polynyas) on cloud micro- and macro-physical properties.
		...
		\item Our results depict that a warming cloud effect on the surface is clearly enhanced by atmospheric thermodynamic and dynamic conditions which are coupled with the sea ice situation downwind.
\end{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{Acknowledges}{name=acknown,column=0, span=2, above=bottom}{
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	{\small This work was supported by the DFG funded Transregio-project TR-172 "Arctic Amplification $(AC)^3$". The authors thanks the DOE ARM program for providing data from the NSA site. SIC data obtained from University of Bremen repository and supported by Dr. Gunnar Spreen. Cloud classification was performed by the open-source \emph{Cloudnetpy} algorithm by ACTRIS and FMI. }
}
\headerbox{Contact: pablosaa@uni-leipzig.de}{name=contact, column=3, above=bottom}{
