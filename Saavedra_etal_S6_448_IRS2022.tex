...
\begin{minipage}{0.99\linewidth}
	\subcaption{figure}
	\subfloat[sub-caption]{\includegraphics[width=.93\linewidth]{CRE_lw_dw.png}}
	\hfill
	\subfloat[sub-caption]{\includegraphics[width=.93\linewidth]{cloud_radiating_T.png}}
	\hfill
	\subfloat[sub-caption]{\includegraphics[width=.93\linewidth]{Fnet_vs_IWP_both.png}}
\end{minipage}
\begin{tabular}{@{}lcr@{}}
