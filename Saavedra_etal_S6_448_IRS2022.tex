...
\begin{tabular*}{0.99\textwidth}[h!]{lc}
	\begin{minipage}{0.45\textwidth}
		\vspace{-3em}
	The Atmospheric Radiation Measurement’s (ARM) North Slope of Alaska (NSA) site (71.23$^\circ$ North, 156.61$^\circ$ West) in Utqiagvik, Alaska.
	\end{minipage}
	&
	\includegraphics[scale=0.55]{NSA_SIC_100km.png}	
\end{tabular*}
\\
NSA provides long-term high-quality in-situ and remote-sensing observations for clouds and radiation. To exclude solar shortwave radiative effects this study is centered on the Arctic winters (November to March) from 2012 to 2020. 	
  }
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{minipage}{0.9\textwidth}
	...
	\caption{\small Coupling / decoupling classification based on $\theta_v$ and location of maximum water vapour transport.}
	\label{fig:cop-dec}
\end{minipage}
...
\]
being $F_{lw}^{\downarrow}$ and $F_{lw}^{\uparrow}$ down- and up-welling longwave fluxes measured at NSA. The surface LW emissivity $\varepsilon_s$ is considered 0.981 $\pm$ 5\% to cover characteristic NSA winter values.\\
 
{The results are sorted based on the cloud-sea ice coupled/decoupled conditions. Statistics of LW net surface radiation and cloud radiative effects (CRE) are show in Section 3.}
